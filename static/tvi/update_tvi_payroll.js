...
//===========================================This function is for inserting Payroll TVI====================================
                            const updatePayrollTVI = async() => {
                                ...
                                if (isFilled) {
                                    try {
                                        const response = await fetch(`/api-update-adan-payroll-tvi/`+ id, {
                                            method: "PUT",
                            ...
                            const Btn_update_payroll = document.querySelector('#Btn_update_payroll');
                            Btn_update_payroll.addEventListener("click", updatePayrollTVI);                  
